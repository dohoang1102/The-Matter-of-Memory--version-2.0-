 ...
 * Copyright (c) 2009-2011 by MatterofMemoryv20, Inc. All Rights Reserved.
...
//@interface MatterofMemoryv20Object : NSObject
//@end

@interface MatterofMemoryv20Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MatterofMemoryv20Object class]])
		{
			for (NSString *key in [[(MatterofMemoryv20Object*)o modules] allKeys])
			{
