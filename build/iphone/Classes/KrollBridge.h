...
@interface MatterofMemoryv20Object : KrollCoverageObject {
#else
@interface MatterofMemoryv20Object : KrollObject {
#endif
@private
...
extern NSString * MatterofMemoryv20$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	MatterofMemoryv20Object *_matterofmemoryv20;
	BOOL shutdown;
