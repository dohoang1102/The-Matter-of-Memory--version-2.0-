...
// in simulator we redefine to format for MatterofMemoryv20 Developer console
...
{\
	NSString * exceptionName = [@"org.matterofmemoryv20." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.matterofmemoryv20";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIMatterofMemoryv20NativeItemNone = -1, 
	UIMatterofMemoryv20NativeItemSpinner = -2,
	UIMatterofMemoryv20NativeItemProgressBar = -3,
	
	UIMatterofMemoryv20NativeItemSlider = -4,
	UIMatterofMemoryv20NativeItemSwitch = -5,
	UIMatterofMemoryv20NativeItemMultiButton = -6,
	UIMatterofMemoryv20NativeItemSegmented = -7,
	
	UIMatterofMemoryv20NativeItemTextView = -8,
	UIMatterofMemoryv20NativeItemTextField = -9,
	UIMatterofMemoryv20NativeItemSearchBar = -10,
	
	UIMatterofMemoryv20NativeItemPicker = -11,
	UIMatterofMemoryv20NativeItemDatePicker = -12,
	
	UIMatterofMemoryv20NativeItemInfoLight = -13,
	UIMatterofMemoryv20NativeItemInfoDark = -14,
	
	UIMatterofMemoryv20NativeItemDisclosure = -15,
	
	UIMatterofMemoryv20NativeItemContactAdd = -16
};
